...
function NETIS名称分類等取得() {
	let data = {
		"技術名称": テキスト正規化($("#技術名称").val()),
		"副題": テキスト正規化($("#副題").val()),
		"技術開発年": テキスト正規化($("#技術開発年").val()),
		"記入年月日": 年月日正規化テキスト用($("#記入年月日").val()),
		...
		"キーワード自由記入1": テキスト正規化($("#キーワード自由記入1").val()),
		"キーワード自由記入2": テキスト正規化($("#キーワード自由記入2").val()),
		"キーワード自由記入3": テキスト正規化($("#キーワード自由記入3").val()),
		"開発目標": チェックボックス値配列取得("開発目標"),
		"開発目標その他": テキスト正規化($("#開発目標その他").val()),
		"開発体制": ラジオ値取得("開発体制"),
		"開発会社": テキスト正規化($("#開発会社").val()),
		"技術の会社": 会社名正規化($("#技術の会社").val()),
		"技術の担当部署": テキスト正規化($("#技術の担当部署").val()),
		"技術の担当者": テキスト正規化($("#技術の担当者").val()),
		"技術の郵便番号": 郵便番号正規化($("#技術の郵便番号").val()),
		"技術の住所": テキスト正規化($("#技術の住所").val()),
		"技術のTEL": 電話番号正規化($("#技術のTEL").val()),
		"技術のFAX": FAX番号正規化($("#技術のFAX").val()),
		"技術のEMAIL": メールアドレス正規化($("#技術のEMAIL").val()),
		"技術のURL": URL正規化($("#技術のURL").val()),
		"営業の会社": 会社名正規化($("#営業の会社").val()),
		"営業の担当部署": テキスト正規化($("#営業の担当部署").val()),
		"営業の担当者": テキスト正規化($("#営業の担当者").val()),
		"営業の郵便番号": 郵便番号正規化($("#営業の郵便番号").val()),
		"営業の住所": テキスト正規化($("#営業の住所").val()),
		"営業のTEL": 電話番号正規化($("#営業のTEL").val()),
		"営業のFAX": FAX番号正規化($("#営業のFAX").val()),
		"営業のEMAIL": メールアドレス正規化($("#営業のEMAIL").val()),
		"営業のURL": URL正規化($("#営業のURL").val()),
...
function NETIS技術概要等取得() {
	let data = {
		"技術概要": 文章正規化($("#技術概要").val()),
		"概要": 文章正規化($("#概要").val()),
		"概要表_タイトル": テキスト正規化($("#概要表_タイトル").val()),
		"概要写真": $("#概要写真_縮小版").attr("src"),
		"概要写真_タイトル": 写真タイトル正規化($("#概要写真_タイトル").val()),
		"概要写真_ファイル名": ファイル名正規化($("#概要写真_ファイル名").val()),
		"概要表_データ": 概要表_データ,
		"概要表_見出し列数": 整数正規化($("#概要表_見出し列数").val()),
		"概要表_見出し行数": 整数正規化($("#概要表_見出し行数").val()),
		"新規性及び期待される効果": 文章正規化($("#新規性及び期待される効果").val()),
		"新規性と効果の写真": $("#新規性と効果の写真_縮小版").attr("src"),
		"新規性と効果の写真_タイトル": 写真タイトル正規化($("#新規性と効果の写真_タイトル").val()),
		"新規性と効果の写真_ファイル名": ファイル名正規化($("#新規性と効果の写真_ファイル名").val()),
		"新規性と効果表_タイトル": 表タイトル正規化($("#新規性と効果表_タイトル").val()),
		"新規性と効果表_データ": 新規性と効果表_データ,
		"新規性と効果表_見出し列数": 整数正規化($("#新規性と効果表_見出し列数").val()),
		"新規性と効果表_見出し行数": 整数正規化($("#新規性と効果表_見出し行数").val()),
		"適用条件": 文章正規化($("#適用条件").val()),
		"適用範囲": 文章正規化($("#適用範囲").val()),
		"留意事項": 文章正規化($("#留意事項").val()),
	};
...
function NETIS従来技術との比較取得() {
	let data = {
		"従来技術名": テキスト正規化($("#従来技術名").val()),
		"基準とする数量": 数値正規化($("#基準とする数量").val()),
		"基準とする単位": テキスト正規化($("#基準とする単位").val()),
		"新技術内訳表_データ": 新技術内訳表_データ,
		"従来技術内訳表_データ": 従来技術内訳表_データ,
		"新技術工程": 数値正規化($("#新技術工程").val()),
		"従来技術工程": 数値正規化($("#従来技術工程").val()),
		"経済性の比較のポイント": テキスト正規化($("#経済性の比較のポイント").val()),
		"工程の比較のポイント": テキスト正規化($("#工程の比較のポイント").val()),
		"品質比較": ラジオ値取得("品質比較"),
		"品質の比較のポイント": テキスト正規化($("#品質の比較のポイント").val()),
		"安全性比較": ラジオ値取得("安全性比較"),
		"安全性の比較のポイント": テキスト正規化($("#安全性の比較のポイント").val()),
		"施工性比較": ラジオ値取得("施工性比較"),
		"施工性の比較のポイント": テキスト正規化($("#施工性の比較のポイント").val()),
		"周辺環境への影響比較": ラジオ値取得("周辺環境への影響比較"),
		"周辺環境への影響の比較のポイント": テキスト正規化($("#周辺環境への影響の比較のポイント").val()),
		"比較用自由設定項目１": テキスト正規化($("#比較用自由設定項目１").val()),
		"自由設定項目１比較": ラジオ値取得("自由設定項目１比較"),
		"自由設定項目１の比較のポイント": テキスト正規化($("#自由設定項目１の比較のポイント").val()),
		"比較用自由設定項目２": テキスト正規化($("#比較用自由設定項目２").val()),
		"自由設定項目２比較": ラジオ値取得("自由設定項目２比較"),
		"自由設定項目２の比較のポイント": テキスト正規化($("#自由設定項目２の比較のポイント").val()),
		"技術のアピールポイント等": 文章正規化($("#技術のアピールポイント等").val()),
		"コストタイプ": テキスト正規化($("#コストタイプ").val()),
		"新技術サイクルコスト1年": 数値正規化($("#新技術サイクルコスト1年").val()),
		"新技術サイクルコスト3年": 数値正規化($("#新技術サイクルコスト3年").val()),
		"新技術サイクルコスト5年": 数値正規化($("#新技術サイクルコスト5年").val()),
		"新技術サイクルコスト10年": 数値正規化($("#新技術サイクルコスト10年").val()),
		"従来技術サイクルコスト1年": 数値正規化($("#従来技術サイクルコスト1年").val()),
		"従来技術サイクルコスト3年": 数値正規化($("#従来技術サイクルコスト3年").val()),
		"従来技術サイクルコスト5年": 数値正規化($("#従来技術サイクルコスト5年").val()),
		"従来技術サイクルコスト10年": 数値正規化($("#従来技術サイクルコスト10年").val()),
		"施行単価": 文章正規化($("#施行単価").val()),
		"費用内訳書表_タイトル": 表タイトル正規化($("#費用内訳書表_タイトル").val()),
		"費用内訳書表_データ": 費用内訳書表_データ,
		"費用内訳書表_見出し列数": 整数正規化($("#費用内訳書表_見出し列数").val()),
		"費用内訳書表_見出し行数": 整数正規化($("#費用内訳書表_見出し行数").val()),
		"歩掛の種類": ラジオ値取得("歩掛の種類"),
		"施工方法": 文章正規化($("#施工方法").val()),
		"施工方法写真": $("#施工方法写真_縮小版").attr("src"),
		"施工方法写真_タイトル": 写真タイトル正規化($("#施工方法写真_タイトル").val()),
		"施工方法写真_ファイル名": ファイル名正規化($("#施工方法写真_ファイル名").val()),
		"施工方法表_タイトル": 表タイトル正規化($("#施工方法表_タイトル").val()),
		"施工方法表_データ": 施工方法表_データ,
		"施工方法表_見出し列数": 整数正規化($("#施工方法表_見出し列数").val()),
		"施工方法表_見出し行数": 整数正規化($("#施工方法表_見出し行数").val()),
		"今後の課題とその対応計画": 文章正規化($("#今後の課題とその対応計画").val()),
	};
	return data;
}
...
function NETIS施工実績等取得() {
	let data = {
		"国土交通省の実績何件": 整数正規化($("#国土交通省の実績何件").val()),
		"国土交通省実績表_データ": 国土交通省実績表_データ,
		"その他公共機関の実績何件": 整数正規化($("#その他公共機関の実績何件").val()),
		"民間の実績何件": 整数正規化($("#民間の実績何件").val()),
		"国土交通省以外実績表_データ": 国土交通省以外実績表_データ,
		"特許の有無": ラジオ値取得('特許の有無'),
		"特許1番号": テキスト正規化($("#特許1番号").val()),
		"特許1の有無": ラジオ値取得("特許1の有無"),
		"特許1通常実施権の有無": ラジオ値取得("特許1通常実施権の有無"),
		"特許1専用実施権の有無": ラジオ値取得("特許1専用実施権の有無"),
		"特許1特許権者": テキスト正規化($("#特許1特許権者").val()),
		"特許1実施権者": テキスト正規化($("#特許1実施権者").val()),
		"特許1特許料等": テキスト正規化($("#特許1特許料等").val()),
		"特許1実施形態": テキスト正規化($("#特許1実施形態").val()),
		"特許1問合せ先": テキスト正規化($("#特許1問合せ先").val()),
		"特許2番号": テキスト正規化($("#特許2番号").val()),
		"特許2の有無": ラジオ値取得("特許2の有無"),
		"特許2通常実施権の有無": ラジオ値取得("特許2通常実施権の有無"),
		"特許2専用実施権の有無": ラジオ値取得("特許2専用実施権の有無"),
		"特許2特許権者": テキスト正規化($("#特許2特許権者").val()),
		"特許2実施権者": テキスト正規化($("#特許2実施権者").val()),
		"特許2特許料等": テキスト正規化($("#特許2特許料等").val()),
		"特許2実施形態": テキスト正規化($("#特許2実施形態").val()),
		"特許2問合せ先": テキスト正規化($("#特許2問合せ先").val()),
		"特許3番号": テキスト正規化($("#特許3番号").val()),
		"特許3の有無": ラジオ値取得("特許3の有無"),
		"特許3通常実施権の有無": ラジオ値取得("特許3通常実施権の有無"),
		"特許3専用実施権の有無": ラジオ値取得("特許3専用実施権の有無"),
		"特許3特許権者": テキスト正規化($("#特許3特許権者").val()),
		"特許3実施権者": テキスト正規化($("#特許3実施権者").val()),
		"特許3特許料等": テキスト正規化($("#特許3特許料等").val()),
		"特許3実施形態": テキスト正規化($("#特許3実施形態").val()),
		"特許3問合せ先": テキスト正規化($("#特許3問合せ先").val()),
		"特許4番号": テキスト正規化($("#特許4番号").val()),
		"特許4の有無": ラジオ値取得("特許4の有無"),
		"特許4通常実施権の有無": ラジオ値取得("特許4通常実施権の有無"),
		"特許4専用実施権の有無": ラジオ値取得("特許4専用実施権の有無"),
		"特許4特許権者": テキスト正規化($("#特許4特許権者").val()),
		"特許4実施権者": テキスト正規化($("#特許4実施権者").val()),
		"特許4特許料等": テキスト正規化($("#特許4特許料等").val()),
		"特許4実施形態": テキスト正規化($("#特許4実施形態").val()),
		"特許4問合せ先": テキスト正規化($("#特許4問合せ先").val()),
		"特許5番号": テキスト正規化($("#特許5番号").val()),
		"特許5の有無": ラジオ値取得("特許5の有無"),
		"特許5通常実施権の有無": ラジオ値取得("特許5通常実施権の有無"),
		"特許5専用実施権の有無": ラジオ値取得("特許5専用実施権の有無"),
		"特許5特許権者": テキスト正規化($("#特許5特許権者").val()),
		"特許5実施権者": テキスト正規化($("#特許5実施権者").val()),
		"特許5特許料等": テキスト正規化($("#特許5特許料等").val()),
		"特許5実施形態": テキスト正規化($("#特許5実施形態").val()),
		"特許5問合せ先": テキスト正規化($("#特許5問合せ先").val()),
		"実用新案の有無": ラジオ値取得("実用新案の有無"),
		"実施新案通常実施権の有無": ラジオ値取得("実施新案通常実施権の有無"),
		"実施新案専用実施権の有無": ラジオ値取得("実施新案専用実施権の有無"),
		"実用新案特許番号": テキスト正規化($("#実用新案特許番号").val()),
		"特許実用新案備考": テキスト正規化($("#特許実用新案備考").val()),
		"建設技術番号": テキスト正規化($("#建設技術番号").val()),
		"港湾関連民間技術の評価年月日": 年月日正規化テキスト用($("#港湾関連民間技術の評価年月日").val()),
		"港湾関連民間技術の評価機関": テキスト正規化($("#港湾関連民間技術の評価機関").val()),
		"港湾関連民間技術の評価URL": URL正規化($("#港湾関連民間技術の評価URL").val()),
		"港湾に係る民間技術評価番号": テキスト正規化($("#港湾に係る民間技術評価番号").val()),
		"民間技術評価の評価年月日": 年月日正規化テキスト用($("#民間技術評価の評価年月日").val()),
		"民間技術評価の評価URL": URL正規化($("#民間技術評価の評価URL").val()),
		"制度の名称1": テキスト正規化($("#制度の名称1").val()),
		"制度の番号1": テキスト正規化($("#制度の番号1").val()),
		"制度の証明年月日1": 年月日正規化テキスト用($("#制度の証明年月日1").val()),
		"制度の証明機関名称1": テキスト正規化($("#制度の証明機関名称1").val()),
		"制度の証明範囲1": テキスト正規化($("#制度の証明範囲1").val()),
		"制度のURL1": URL正規化($("#制度のURL1").val()),
		"制度の名称2": テキスト正規化($("#制度の名称2").val()),
		"制度の番号2": テキスト正規化($("#制度の番号2").val()),
		"制度の証明年月日2": 年月日正規化テキスト用($("#制度の証明年月日2").val()),
		"制度の証明機関名称2": テキスト正規化($("#制度の証明機関名称2").val()),
		"制度の証明範囲2": テキスト正規化($("#制度の証明範囲2").val()),
		"制度のURL2": URL正規化($("#制度のURL2").val()),
		"証明項目表_データ": 証明項目表_データ,
		"実験等実施状況": 文章正規化($("#実験等実施状況").val()),
		"実験等実施状況写真": $("#実験等実施状況写真_縮小版").attr("src"),
		"実験等実施状況写真_タイトル": 写真タイトル正規化($("#実験等実施状況写真_タイトル").val()),
		"実験等実施状況写真_ファイル名": ファイル名正規化($("#実験等実施状況写真_ファイル名").val()),
		"実験等実施状況表_タイトル": 表タイトル正規化($("#実験等実施状況表_タイトル").val()),
		"実験等実施状況表_データ": 実験等実施状況表_データ,
		"実験等実施状況表_見出し列数": 整数正規化($("#実験等実施状況表_見出し列数").val()),
		"実験等実施状況表_見出し行数": 整数正規化($("#実験等実施状況表_見出し行数").val()),
		"添付資料": 文章正規化($("#添付資料").val()),
		"参考文献": 文章正規化($("#参考文献").val()),
		"その他の写真1": $("#その他の写真1_縮小版").attr("src"),
		"その他の写真1_タイトル": 写真タイトル正規化($("#その他の写真1_タイトル").val()),
		"その他の写真1_ファイル名": ファイル名正規化($("#その他の写真1_ファイル名").val()),
		"その他の写真2": $("#その他の写真2_縮小版").attr("src"),
		"その他の写真2_タイトル": 写真タイトル正規化($("#その他の写真2_タイトル").val()),
		"その他の写真2_ファイル名": ファイル名正規化($("#その他の写真2_ファイル名").val()),
		"その他の写真3": $("#その他の写真3_縮小版").attr("src"),
		"その他の写真3_タイトル": 写真タイトル正規化($("#その他の写真3_タイトル").val()),
		"その他の写真3_ファイル名": ファイル名正規化($("#その他の写真3_ファイル名").val()),
	};
	return data;
}
...
function NETIS名称分類等監査(data, 監査結果) {
	...
	if (data["キーワード"].length > 3) {
		監査結果[0] = 監査失敗;
		監査結果[1] += "エラー：名称分類等の「キーワード」は３個までにして下さい。\r\n";
	}
	if (data["開発目標"].length == 0) {
		監査結果[0] = 監査失敗;
		監査結果[1] += "エラー：名称分類等の「開発目標」が無指定です。\r\n";
	}
	if (data["開発目標"].length > 3) {
		監査結果[0] = 監査失敗;
		監査結果[1] += "エラー：名称分類等の「開発目標」は３個までにして下さい。\r\n";
	}
	if (data["開発体制"] == '') {
		監査結果[0] = 監査失敗;

...
function NETIS施工実績等設定(data) {
	...
	$("#港湾関連民間技術の評価年月日").val(年月日正規化(data["港湾関連民間技術の評価年月日"]));
	...
	$("#制度の証明年月日2").val(年月日正規化(data["制度の証明年月日2"]));

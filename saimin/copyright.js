...
※ ソース1: https://github.com/katahiromz/katahiromz.github.io
※ ソース2: https://github.com/katahiromz/KraKra_ja_jp
※ 一部、OtoLogicの音声素材を使用。
...
- 「mic」にチェックを入れるとマイクが使えます。
- 「画」ボタンで映像を選べます。
- 「音!」ボタンで音がなります。
- 「字」ボタンで表示するメッセージを設定できます。
- チェックボタン「話」をチェックするとメッセージを自動音声でしゃべります。
- 「設」ボタンで全般設定ができます。

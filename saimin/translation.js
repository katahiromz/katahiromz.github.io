...
const trans_localize = function(lang){
	...
	if(lang == 'ja' || lang == 'jp'){ // Japanese
		...
		trans_setSelectOptionText(sai_id_select_sound, 'Pachi1', 'パチ 1');
		trans_setSelectOptionText(sai_id_select_sound, 'Pachi2', 'パチ 2');
		...
		trans_setSelectOptionText(sai_id_select_sound, 'Pachi1', '弹珠 1');
		trans_setSelectOptionText(sai_id_select_sound, 'Pachi2', '弹珠 2');
		...
		trans_setSelectOptionText(sai_id_select_sound, 'Pachi1', '彈珠 1');
		trans_setSelectOptionText(sai_id_select_sound, 'Pachi2', '彈珠 2');
		...
		trans_setSelectOptionText(sai_id_select_sound, 'Pachi1', '파칭 1');
		trans_setSelectOptionText(sai_id_select_sound, 'Pachi2', '파칭 2');
		...
		trans_setSelectOptionText(sai_id_select_sound, 'Pachi1', 'Pachi 1');
		trans_setSelectOptionText(sai_id_select_sound, 'Pachi2', 'Pachi 2');
		...
		trans_setSelectOptionText(sai_id_select_sound, 'Pachi1', 'Pachi 1');
		trans_setSelectOptionText(sai_id_select_sound, 'Pachi2', 'Pachi 1');
		...
		trans_setSelectOptionText(sai_id_select_sound, 'Pachi1', 'Пачи 1');
		trans_setSelectOptionText(sai_id_select_sound, 'Pachi2', 'Пачи 2');
